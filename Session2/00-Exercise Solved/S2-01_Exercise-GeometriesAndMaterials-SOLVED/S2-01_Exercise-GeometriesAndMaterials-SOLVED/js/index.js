...
var texture=new THREE.TextureLoader().load("texture/wood.jpg");

var material4=new THREE.MeshBasicMaterial({map:texture});

var texture=new THREE.TextureLoader().load("texture/matel.jpg");
...
var mesh3 = new THREE.Mesh( geometry, material8 );
mesh3.position.z = -1000;
mesh3.position.x = -200;
mesh3.position.y = 100;

var mesh4 = new THREE.Mesh( geometry, material7 );
